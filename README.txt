...
NOTE: here "input.txt" is a text file containing tokens and lexemes formatted in the way described above.  "input2.txt" and "while.txt" are other example text files.
